...
export const contactItems = [
  {
    ...
    icon: <Mail size={24} />,
    bgColor: "bg-blue-500 p-3",
  },
  {
    label: "Phone",
    value: "010-3104-5118",
    icon: <Phone size={24} />,
    bgColor: "bg-green-500 p-3",
  },
  {
    label: "Github",
    value: "github.com/JeongCW0522",
    icon: <TbBrandGithub size={24} />,
    bgColor: "bg-black p-3",
    link: "https://github.com/JeongCW0522",
  },
  {
    label: "Instagram",
    value: "instagram.com/cherrykok123",
    icon: <TbBrandInstagram size={30} />,
    bgColor: "bg-linear-to-br from-purple-500 via-pink-500 to-orange-500 p-2",
  ...
  },
  {
    ...
    value: "Seoul, Guro-gu",
    icon: <MapPin size={24} />,
    bgColor: "bg-linear-to-br from-orange-600 to-orange-400 p-3",
  },
];

...
const SkillCard = ({ title, skills, color, hoverColor }) => {
  return (
    <div
      className={clsx(
        "w-full max-w-xl p-8 rounded-3xl border-2 bg-linear-to-br from-[#4c3769] to-[rgb(5,37,85)] shadow-lg",
        "transition-all duration-300 hover:-translate-y-1 hover:scale-103",
        hoverColor
      )}
    >
      <h2 className="text-gray-200 text-2xl font-semibold mb-6">{title}</h2>

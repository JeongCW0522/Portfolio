...
const TechStack = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl p-10 bg-linear-to-br from-blue-600 to-blue-400 border border-[#272727] rounded-3xl">
        ...
        {isOpen && (
          <div className="mt-10 -mb-10 -mx-10 p-10 rounded-b-2xl bg-linear-to-br from-[#271b38] to-[rgb(1,11,26)] border border-white/10">
            <img
              src={Project1}
              alt="북마크 플랫폼"
